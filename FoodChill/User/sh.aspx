<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="sh.aspx.cs" Inherits="User_sh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p id="rname"> Shawarma House</p>
	<p id="caption"> Find out your favorite food from Shawarma House. Add to cart to order.</p>
