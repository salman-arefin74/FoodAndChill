<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="alfresco.aspx.cs" Inherits="User_alfresco" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p id="rname"> Al Fresco</p>
	<p id="caption"> Find out your favorite food from Al Fresco. Add to cart to order.</p>
