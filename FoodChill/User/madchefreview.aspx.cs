...
public partial class User_madchefreview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from Feedback where Res_name = 'madchef'";
        cmd.ExecuteNonQuery();
    ...
    protected void show_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = con.CreateCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "insert into Feedback values('" + val2 + "','" + rateBox.Text + "','" + reviewBox.Text + "', 'madchef')";
        cmd.ExecuteNonQuery();
