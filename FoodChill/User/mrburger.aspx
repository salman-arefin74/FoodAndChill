<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="mrburger.aspx.cs" Inherits="User_mrburger" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="list">
    ...
    <p id="rname"> Mr. Burger</p>
	<p id="caption"> Find out your favorite food from Mr. Burger. Add to cart to order.</p>
