<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="chef.aspx.cs" Inherits="User_chef" %>
...
<div id="list">
    ...
    <p id="rname"> Chef's Cuisine</p>
	<p id="caption"> Find out your favorite food from Chef's Cuisine. Add to cart to order.</p>
