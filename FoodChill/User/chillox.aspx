<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="chillox.aspx.cs" Inherits="User_chillox" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p id="rname"> Chillox</p>
	<p id="caption"> Find out your favorite food from Chillox. Add to cart to order.</p>
