<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="madchef.aspx.cs" Inherits="User_madchef" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p id="rname">Madchef</p>
	<p id="caption"> Find out your favorite food from Madchef. Add to cart to order.</p>
