...
public partial class User_alfresco : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from Restaurant where res_name = 'Al Fresco'";
        cmd.ExecuteNonQuery();
    ...
    protected void rBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("alfrescoreview.aspx");
        }
