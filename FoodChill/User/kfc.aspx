<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="kfc.aspx.cs" Inherits="User_kfc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p id="rname"> KFC</p>
	<p id="caption"> Find out your favorite food from KFC. Add to cart to order.</p>
