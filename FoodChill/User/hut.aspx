<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="hut.aspx.cs" Inherits="User_hut" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p id="rname"> Pizza Hut</p>
	<p id="caption"> Find out your favorite food from Pizza Hut. Add to cart to order.</p>
