<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_master.master" AutoEventWireup="true" CodeFile="boomers.aspx.cs" Inherits="User_boomers" %>
...
<div id="list">
    ...
    <p id="rname"> BOOMERS</p>
	<p id="caption"> Find out your favorite food from Boomers. Add to cart to order.</p>
