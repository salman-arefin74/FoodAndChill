...
public partial class User_mrburger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from Restaurant where res_name = 'Mr Burger'";
        cmd.ExecuteNonQuery();
    ...
    protected void rBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("mrburgerreview.aspx");
        }
