<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FoodAddition.aspx.cs" Inherits="Managers_FoodAddition" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Food Item Addition</title>
  ...
  <a href="../User/Offers.aspx" class="w3-bar-item w3-button w3-mobile">Offers</a>
    ...
    <h2>Add Food Items</h2> <br /><br />
      ...
      <p><asp:TextBox ID="t1" CssClass="w3-input w3-padding-16 w3-border" placholder="Area"  runat="server"></asp:TextBox></p>
       <p> <asp:Label>Item Name</asp:Label> </p>
            <p><asp:TextBox ID="t2" CssClass="w3-input w3-padding-16 w3-border" placholder="Restaurant Name" runat="server"></asp:TextBox></p>
       <p> <asp:Label>Category</asp:Label> </p>
            <p><asp:TextBox ID="t3" CssClass="w3-input w3-padding-16 w3-border" placholder="Link" runat="server"></asp:TextBox></p>
       <p> <asp:Label>Price</asp:Label> </p>
